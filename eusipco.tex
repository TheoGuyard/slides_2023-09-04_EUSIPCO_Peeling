...
\date{\scriptsize{$^{\star}$ICTEAM, UCLouvain, Belgium \\ $^{\dagger}$SIMSMART, Inria, France \\ $^{\ddagger}$IETR, CentraleSupelec, France}}
\author{\textbf{Gilles Monnoyer}${}^{\star}$, Th\'{e}o Guyard$^{\dagger}$, C\'{e}dric Herzet${}^{\dagger}$ and Cl\'{e}ment Elvira$^{\ddagger}$}
\institute{EUSIPCO - European Signal Processing Conference \\ Helsinki, Finland \\ September 4-8, 2023}
